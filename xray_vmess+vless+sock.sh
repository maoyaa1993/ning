...
DEFAULT_VMESS_START_PORT=20000                         # 默认VMess起始端口
...
Xray() {
    ...
    echo -e "  ${GREEN}5.${PLAIN}  搭建VMESS-WS"
    echo -e "  ${GREEN}6.${PLAIN}  搭建SOCKS5"
    echo -e "  ${GREEN}7.${PLAIN}  查看reality链接"
    echo " -------------"
    echo -e "  ${GREEN}8.${PLAIN}  启动xray"
    echo -e "  ${GREEN}9.${PLAIN}  重启xray"
    echo -e "  ${GREEN}10.${PLAIN}  停止xray"
    echo " -------------"
    echo -e "  ${GREEN}11.${PLAIN}  返回上一级菜单"
